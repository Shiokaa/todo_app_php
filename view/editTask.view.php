...
<body class="h-screen w-full flex flex-col justify-center items-center bg-gray-300">
    ...
    <div class="flex items-center justify-between w-full p-4 mb-8">
        <h1 class="text-2xl lg:text-4xl">Editer la tâche : <?= $task['name'] ?></h1>
        <a href="/tasks">
    ...
    <form action="/editTask" method="POST" class="w-full p-4 flex flex-col gap-6">
        <input type="hidden" name="id" value="<?= $id?>">
        <div class="flex flex-col gap-2">
            <label for="name" class="text-lg font-medium text-gray-700">Nouveau titre de la tâche</label>
            <input 
                type="text" 
                name="name" 
                id="name" 
        ...
        <div class="flex flex-col gap-2">
            <label for="text" class="text-lg font-medium text-gray-700">Nouvelle description</label>
            <textarea 
                name="text" 
                id="text" 
                rows="4"
